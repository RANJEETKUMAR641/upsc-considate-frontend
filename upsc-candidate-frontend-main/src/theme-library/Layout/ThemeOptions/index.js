...
import sideBar1 from 'app/assets/utils/images/sidebar/abstract1.jpg'
import sideBar2 from 'app/assets/utils/images/sidebar/abstract2.jpg'
import sideBar3 from 'app/assets/utils/images/sidebar/abstract3.jpg'
import sideBar4 from 'app/assets/utils/images/sidebar/abstract4.jpg'
import sideBar5 from 'app/assets/utils/images/sidebar/abstract5.jpg'

import sideBar6 from 'app/assets/utils/images/sidebar/city1.jpg'
import sideBar7 from 'app/assets/utils/images/sidebar/city2.jpg'
import sideBar8 from 'app/assets/utils/images/sidebar/city3.jpg'
import sideBar9 from 'app/assets/utils/images/sidebar/city4.jpg'
import sideBar10 from 'app/assets/utils/images/sidebar/city5.jpg'
...
class ThemeOptions extends Component {
  ...
  changeColorTheme = (theme) => {
    document.body.className = theme // Apply the new theme
    localStorage.setItem('theme', theme) // Store the theme in localStorage
    this.props.setHeaderBackgroundColor(theme)
  }

  changeSidebarColorTheme = (theme) => {
    document.body.className = theme // Apply the new theme
    localStorage.setItem('themes', theme) // Store the theme in localStorage
    this.props.setBackgroundColor(theme)
  }
  ...
  componentDidMount() {
    ...
    if (storedTheme) {
      document.body.className = storedTheme // Apply the stored theme
      this.props.setHeaderBackgroundColor(storedTheme)
    } else {
      this.props.setHeaderBackgroundColor('bg-warning')

      // Use a default theme if none is stored
    ...
    if (storedThemes) {
      document.body.className = storedThemes // Apply the stored theme
      this.props.setBackgroundColor(storedThemes)
    } else {
      this.props.setBackgroundColor('bg-dark sidebar-text-light')

      // Use a default theme if none is stored
      document.body.className = 'bg-dark sidebar-text-light'
    }
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          <IoMdSettings color="#333333" fontSize="23px" />
        </Button>
        {/* <Button
        ...
        <div
          className={'ui-theme-settings ' + (showing ? 'settings-open' : '')}
        >
              ...
              <div className="theme-settings__options-wrapper">
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => this.setState({ showing: !showing })}
                  >
                    <CloseIcon color="#000000" fontSize="medium" />
                  </Button>
                </h3>
                <div className="p-3">
                  <ListGroup>
                    ...
                    <ListGroupItem>
                      ...
                      <div className="theme-settings-swatches">
                        ...
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-info header-text-light')
                          }
                        />
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-warning header-text-dark')
                          }
                        />
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-danger header-text-light')
                          }
                        />
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-light header-text-dark')
                          }
                        />
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-dark header-text-light')
                          }
                        />
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-focus header-text-light')
                          }
                        />
                        <div
                        ...
                        <div
                          ...
                          onClick={() =>
                            this.changeColorTheme('bg-royal header-text-light')
                          }
                        />
                        <div
                            ...
                            <ButtonGroup size="sm">
                              ...
                              <Button
                                className={cx('btn-shadow opacity-5', {
                                  active:
                                    backgroundImageOpacity === 'opacity-08',
                                })}
                                color="primary"
                                onClick={() =>
