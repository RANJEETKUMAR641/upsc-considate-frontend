...
import bg4 from 'app/assets/utils/images/dropdown-header/city5.jpg'
      ...
      <Fragment>
        <Nav className="header-megamenu">
          ...
          <Popover
            ...
            toggle={this.toggle}
            aria-labelledby="PopoverMegaMenuFooter"
          >
                    ...
                    <Nav vertical>
                      ...
                      <NavItem>
                        <NavLink href="#">
                          ...
                          <Typography varient="h6">Incidents</Typography>
                      ...
                      <NavItem>
                        <NavLink href="#">
                          ...
                          <Typography varient="h6">Companies</Typography>
                        </NavLink>
                      </NavItem>
                      <NavItem>
                        <NavLink disabled href="#">
                          <i className="nav-link-icon lnr-file-empty"> </i>
                          <Typography varient="h6">Dashboards</Typography>
                        </NavLink>
                      </NavItem>
                    </Nav>
                  </Col>
          ...
          <Popover
            ...
            toggle={this.toggle2}
            aria-labelledby="PopoverGridFooter"
          >
            <div className="dropdown-menu-header">
              <div className="dropdown-menu-header-inner bg-tempting-azure">
                ...
                <div className="menu-header-content text-dark">
                  <Typography varient="h5" className="menu-header-title">
                    Two Column Grid
                  </Typography>
                  <Typography varient="h6" className="menu-header-subtitle">
            ...
            <Nav vertical>
              ...
              <NavItem className="nav-item-btn clearfix">
                <div className="float-start">
                  <Button size="sm" color="link" aria-label="LinkButton">
                    Link Button
                  </Button>
                </div>
