...
import city2 from 'app/assets/utils/images/dropdown-header/city2.jpg'
import avatar6 from 'app/assets/utils/images/avatars/2.jpg'
      ...
      <Fragment>
        <div className="footer-dots">
          <a
            ...
            aria-haspopup="true"
            aria-expanded={this.state.popoverOpen1}
          >
          ...
          <a
            ...
            aria-haspopup="true"
            aria-expanded={this.state.popoverOpen3}
          >
          ...
          <Popover
            ...
            toggle={this.toggle1}
            aria-hidden={!this.state.popoverOpen1}
          >
            <div className="dropdown-menu-header mb-0">
              <div className="dropdown-menu-header-inner bg-strong-bliss">
                ...
                <div className="menu-header-content text-white">
                  ...
                  <Typography variant="h6" className="menu-header-subtitle">
          ...
          <Popover
            ...
            toggle={this.toggle3}
            aria-hidden={!this.state.popoverOpen3}
          >
